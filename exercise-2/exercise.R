...
salaries.data.frame<-data.frame(employees, salaries.2014, salaries.2015)

# Create a column 'raise' that stores the size of the raise between 2014 and 2015
salaries.data.frame$raise = salaries.2015 - salaries.2014

# Create a column 'got.raise' that is TRUE if the person got a raise
salaries.data.frame$got.raise = salaries.2015 > salaries.2014
...
salaries.data.frame$salaries.2015[employees = "Employee 57"]

View(salaries.data.frame)
